...
@Composable
fun SetPublicKey(modifier: Modifier = Modifier, navHostController: NavHostController) {
...
@Preview
@Composable
private fun SetPublicKeyPreview() {
    SetPublicKey(navHostController = rememberNavController())
}